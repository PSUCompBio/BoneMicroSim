                   ...
                   for(m=0;m<PhiInc;m++){
                      ...
                      for(l=0;l<AngleInc;l++){
                         ...
                         system(s);
                           ...
                           fprintf(submitjobs, "rm d3dump* mes* scr* disk* status* d3h* adp* *.pbs.o*\n");
...
for(i=1;i<nnodes+1;i++){  
     if(coordinates[ndim*(i-1)+0]>max_x-tolerance){
     count = count + 1;
        if(count<8){
...
for(i=1;i<nnodes+1;i++){  
     if(coordinates[ndim*(i-1)+0]-min_x<tolerance){
        count = count + 1;
        if(count<8){
          fprintf(nodeset,"%10.0d",i);
        } 
...
fprintf(nodeset, "$#    nid1      nid2      nid3      nid4      nid5      nid6      nid7      nid8\n");
for(i=1;i<nnodes+1;i++){  
     if(coordinates[ndim*(i-1)+1]>max_y-tolerance){
     count = count + 1;
     if(count<8){
       fprintf(nodeset,"%10.0d",i);
     } 
...
fprintf(nodeset, "$#    nid1      nid2      nid3      nid4      nid5      nid6      nid7      nid8\n");
for(i=1;i<nnodes+1;i++){  
     if(coordinates[ndim*(i-1)+2]>max_z-tolerance){
     count = count + 1;
     if(count<8){
       fprintf(nodeset,"%10.0d",i);
     } 
...
fprintf(nodeset, "$#    nid1      nid2      nid3      nid4      nid5      nid6      nid7      nid8\n");
for(i=1;i<nnodes+1;i++){  
     if(coordinates[ndim*(i-1)+2]-min_z<tolerance){
     count = count + 1;
     if(count<8){
       fprintf(nodeset,"%10.0d",i);
     } 
